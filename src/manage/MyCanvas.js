...
import {  faChair,faSquareCheck,faStar,faDoorOpen,faTrashCan,faPenToSquare,faWindowClose } from "@fortawesome/free-solid-svg-icons";
...
const eraseAll = ()=>{
  ...
  return (
    <Container>
       ...
       */}
      <button onClick={openModal}><p><FontAwesomeIcon icon={faChair} /></p><span>테이블 생성</span> </button>
      <button onClick={createSeat}><p><FontAwesomeIcon icon={faStar} /></p><span> 좌석 생성</span></button>
      <button onClick={createWall}><p><FontAwesomeIcon icon={faChair} /></p><span>벽 생성</span></button>
      <button onClick={createWindow}><p><FontAwesomeIcon icon={faWindowClose} /></p><span>창문 생성</span></button>
      <button onClick={createDoor}><p><FontAwesomeIcon icon={faDoorOpen} /></p><span>출입구 생성</span></button>
      <button onClick={postData}><p><FontAwesomeIcon icon={faSquareCheck} /></p><span>Submit</span></button>
      <button onClick={changeInfo}><p><FontAwesomeIcon icon={faPenToSquare} /></p><span>수정</span></button>
      {/* <button onClick={eraseAll}><p><FontAwesomeIcon icon={faPenToSquare} /></p><span>모두 지우기</span></button> */}

      <Garbage onMouseUp={handleDelete}><FontAwesomeIcon icon={faTrashCan} /></Garbage>
      </ButtonContainer>
      <CanvasContainer>
      <Stage
