    ...
    <Container>
      ...
      <InputFormDiv>
        <form style={{ borderTop: "1px solid",height:"500px"}}>
          <div style={{ width: "100%", height: "150px", display:"flex",justifyContent:"space-between"}}>
            <div style={{width:"70%"}}>
            <InputContainer>
              <NameBox>
                <p>상호명</p>
        ...
        <form>
          {/* <div style={{ width: "100%", height: "100px",}}> */}
           <InputContainer style={{height:"80px",  marginTop:"10px" ,borderTop: "1px solid "}}>
            <NameBox>
                <p>번호</p>
            </NameBox>
            <NumContainer>
          ...
          {/* <div style={{ width: "100%", height: "400px", marginTop:"10px" }}> */}
           <InputContainer style={{ height:"80px",borderTop: "1px solid", marginTop:"20px"}}>
            <NameBox>
                <p>시간</p>
            </NameBox>
            <NumContainer>
