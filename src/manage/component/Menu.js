...
const Menu = ({ marketId }) => {
    ...
    const menuPost = (postData) => {
        ...
        data.append("menu", new Blob([JSON.stringify(content)], { type: "application/json" }));
                    ...
                    {addMenu ? (
                        <MenuInput>
                            ...
                            <MenuProp className="menuDesc">
                                <textarea {...register("menuDesc", {})} placeholder="상세설명" />
                            </MenuProp>
                            <MenuProp className="menuDel">
                                <input {...register("menuMain", {})} type="checkbox" id="check1" />
