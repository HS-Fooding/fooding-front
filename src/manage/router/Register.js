    ...
    return (
        <Container>
            ...
            <div ref={infoRef}>
                <InputFormDiv>
                    ...
                    <InfoForm>
                        ...
                        {marketInfo === null ? <Button onClick={submitInfo}>등록</Button> : null}
                    </InfoForm>
                </InputFormDiv>
            </div>
            <CanvasContainer ref={structRef}>
                ...
                <AnimatePresence>
                    {alertModal && alertStructure ? <Modal>등록이 완료되었습니다.</Modal> : null}
                </AnimatePresence>
                <AnimatePresence>
                    {failModal && alertStructure ? <Modal>등록에 실패하였습니다.</Modal> : null}
                </AnimatePresence>
            </CanvasContainer>
            <div ref={menuRef}>
